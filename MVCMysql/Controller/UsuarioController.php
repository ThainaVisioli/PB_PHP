...
class UsuarioController{
    ...
    public function cadastrar(){
        ...
        $usuario->salvar();
        header('Location: /PBE/PB_PHP/MVCMysql/usuario/telaCadastro');
        exit;
    }
    ...
    public function atualizar(){
        ...
        header('Location:/PBE/PB_PHP/MVCMysql/usuario/telaEditar?id='.($_GET['id']));
        exit;
    }

    public function excluir(){
        Usuario::excluir($_GET['id']); 
        header('Location: /PBE/PB_PHP/MVCMysql/usuario/listar');
        exit;
    }
}